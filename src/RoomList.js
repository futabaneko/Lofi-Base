...
function RoomList({ user }) {
  ...
  useEffect(() => {
    async function loadUserProfile() {
      if (!user?.uid) return;  // 安全確認
      const docSnap = await fetchUserData(user.uid);
      ...
      <div className="container py-4">
          ...
          {rooms.length !== 0 && (
            <button className="list-group-item list-group-item-action">
              <div className="d-flex flex-wrap align-items-center">
                ...
                <div className="col-1 col-md-1 mb-2">
                  <strong>人数</strong>
                </div>
                <div className="d-none d-md-block col-md-2 mb-2">
                  <strong>作成者</strong>
                </div>
        ...
        <div class="my-2">
          ...
          {profile && profile.isAdmin && (
            <Link to="/create-room" className="btn btn-outline-primary my-2">
              ＋ 新しい部屋を作成
            </Link>
          )}
        </div>
